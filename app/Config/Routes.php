...
$routes->group('super_admin', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->group('pegawai', function ($routes) {
        $routes->get('/', 'SuperAdmin/PegawaiController::index');
        $routes->get('create', 'SuperAdmin/PegawaiController::create');
        $routes->post('store', 'SuperAdmin/PegawaiController::store');
        
        $routes->post('update', 'SuperAdmin/PegawaiController::update');
        $routes->post('delete', 'SuperAdmin/PegawaiController::delete');

        
        $routes->post('export_pdf', 'SuperAdmin/PegawaiController::export_pdf');
        $routes->get('export_excel', 'SuperAdmin/PegawaiController::export_excel');
    });
});
...
$routes->group('user', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->group('createcv', function ($routes) {
        $routes->get('/', 'Consumer/CreatecvController::index');
    });

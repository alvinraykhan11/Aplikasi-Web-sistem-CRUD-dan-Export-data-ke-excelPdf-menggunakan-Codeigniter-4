<?= $this->extend("user/navbar") ?>

<?= $this->section("title") ?>
Create CV - Bank Sampah
<?= $this->endSection(); ?>
...
<link href="<?= base_url('cvfrond/css/bootstrap.css'); ?>" rel='stylesheet' type='text/css' />
<!-- jQuery (necessary JavaScript plugins) -->
<script src="<?= base_url('cvfrond/js/jquery.min.js'); ?>"></script>
<!-- Custom Theme files -->
 <link href="<?= base_url('cvfrond/css/dashboard.css'); ?>" rel="stylesheet">
<link href="<?= base_url('cvfrond/css/style.css'); ?>" rel='stylesheet' type='text/css' />
...
<div class="col-sm-3 col-md-2 sidebar">
		 <div class="sidebar_top">
			 <h1>USER NAME</h1> 
			 <img src="<?= base_url('cvfrond/images/avt.png'); ?>" alt=""/>
		 </div>
		<div class="details">
			 <h3>PHONE</h3>
			 <p>+00 234 56 789</p>  	 
...
<!---->
<link href=" <?= base_url('cvfrond/css/popuo-box.css'); ?>" rel="stylesheet" type="text/css" media="all"/>
<script src="<?= base_url('cvfrond/js/jquery.magnific-popup.js'); ?>" type="text/javascript"></script>
	<!---//pop-up-box---->			
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	 <div class="content">
		 <div class="details_header">
			 <ul>
				 <li><a href="/user/createcv/tambah"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>Create</a></li>
				 ...
				 <div id="small-dialog" class="mfp-hide">
					 <img src="<?= base_url('cvfrond/images/g4.jpg'); ?>" alt=""/>
				 </div>
				 <script>
		 ...
		 <div class="copywrite">
			 <p>© 2022 Curriculum Vitae All Rights Reseverd | Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
		 </div>
	 </div>
</div>
<?= $this->endSection(); ?>

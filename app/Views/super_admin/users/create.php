...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('super_admin/users/store') ?>" method="post">
            <?= csrf_field(); ?>
            ...
            <div class="modal-footer">
                <a href="/super_admin/users"><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
